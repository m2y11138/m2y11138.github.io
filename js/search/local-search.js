  ...
  getResultItems(keywords) {
    ...
    this.datas.forEach(({ title, content, url }) => {
      ...
      if (slicesOfTitle.length !== 0) {
        resultItem += `<li class="local-search-hit-item"><a href="${
          url.href
...
window.addEventListener("load", () => {
  // Search
  const { path, top_n_per_article, unescape, languages, pagination } =
  ...
  const elements = {
    get pagination() {
      return document.getElementById("local-search-pagination");
    },
    get paginationList() {
      return document.querySelector(
        "#local-search-pagination .ais-Pagination-list"
      );
    },
  };
  ...
  const renderResults = (searchText, resultItems) => {
    ...
    container.innerHTML = `<ol class="search-result-list">${numberedItems.join(
      ""
    )}</ol>`;

    // Update stats
    const displayCount = enablePagination
  ...
  const renderPagination = (page, nbPages, query) => {
      ...
      if (isSelected) {
        pagesHTML += `
          <li class="ais-Pagination-item ais-Pagination-item--page ais-Pagination-item--selected">
            <span class="ais-Pagination-link" aria-label="Page ${i + 1}">${
          i + 1
        }</span>
          </li>`;
      } else {
        pagesHTML += `
          <li class="ais-Pagination-item ais-Pagination-item--page">
            <a class="ais-Pagination-link" aria-label="Page ${
              i + 1
            }" href="#" data-page="${i}">${i + 1}</a>
          </li>`;
      }
    }
    ...
    if (nbPages > maxVisiblePages && endPage < nbPages - 1) {
      ...
      pagesHTML += `
        <li class="ais-Pagination-item ais-Pagination-item--page">
          <a class="ais-Pagination-link" aria-label="Page ${nbPages}" href="#" data-page="${
        nbPages - 1
      }">${nbPages}</a>
        </li>`;
    }
            ...
            <li class="ais-Pagination-item ais-Pagination-item--previousPage ${
              ...
              ${
                isFirstPage
                  ...
                  : `<a class="ais-Pagination-link" aria-label="Previous Page" href="#" data-page="${
                      page - 1
            ...
            <li class="ais-Pagination-item ais-Pagination-item--nextPage ${
              ...
              ${
                isLastPage
                  ...
                  : `<a class="ais-Pagination-link" aria-label="Next Page" href="#" data-page="${
                      page + 1
